...
for i in range(rows):
    for j in range(cols-6):
        img_new7[i][j+3] = (gray[i][j]*kernal[0])+(gray[i][j+1]*kernal[1])+(gray[i][j+2]*kernal[2])+(gray[i][j+3]*kernal[3])+(gray[i][j+4]*kernal[4])
        +(gray[i][j+5]*kernal[5])+(gray[i][j+6]*kernal[6])
for i in range(cols):
    for j in range(rows-6):
        img_new7[j+3][i] = (img_new7[j][i]*kernal[0])+(img_new7[j+1][i]*kernal[1])+(img_new7[j+2][i]*kernal[2])+(img_new7[j+3][i]*kernal[3])+(img_new7[j+4][i]*kernal[4])
        +(img_new7[j+5][i]*kernal[5])+(img_new7[j+6][i]*kernal[6])
...
for i in range(rows):
    for j in range(cols-8):
        img_new9[i][j+4] = (gray[i][j]*kernal[0])+(gray[i][j+1]*kernal[1])+(gray[i][j+2]*kernal[2])+(gray[i][j+3]*kernal[3])+(gray[i][j+4]*kernal[4])
        +(gray[i][j+5]*kernal[5])+(gray[i][j+6]*kernal[6])+(gray[i][j+7]*kernal[7])+(gray[i][j+8]*kernal[8])
for i in range(cols):
    for j in range(rows-8):
        img_new9[j+4][i] = (img_new9[j][i]*kernal[0])+(img_new9[j+1][i]*kernal[1])+(img_new9[j+2][i]*kernal[2])+(img_new9[j+3][i]*kernal[3])+(img_new9[j+4][i]*kernal[4])
        +(img_new9[j+5][i]*kernal[5])+(img_new9[j+6][i]*kernal[6])+(img_new9[j+7][i]*kernal[7])+(img_new9[j+8][i]*kernal[8])
...
for i in range(rows):
    for j in range(cols-10):
        img_new11[i][j+5] = (gray[i][j]*kernal[0])+(gray[i][j+1]*kernal[1])+(gray[i][j+2]*kernal[2])+(gray[i][j+3]*kernal[3])+(gray[i][j+4]*kernal[4])
        +(gray[i][j+5]*kernal[5])+(gray[i][j+6]*kernal[6])+(gray[i][j+7]*kernal[7])+(gray[i][j+8]*kernal[8])+(gray[i][j+9]*kernal[9])+(gray[i][j+10]*kernal[10])
for i in range(cols):
    for j in range(rows-10):
        img_new11[j+5][i] = (img_new11[j][i]*kernal[0])+(img_new11[j+1][i]*kernal[1])+(img_new11[j+2][i]*kernal[2])+(img_new11[j+3][i]*kernal[3])+(img_new11[j+4][i]*kernal[4])
        +(img_new11[j+5][i]*kernal[5])+(img_new11[j+6][i]*kernal[6])+(img_new11[j+7][i]*kernal[7])+(img_new11[j+8][i]*kernal[8])+(img_new11[j+9][i]*kernal[9])+(img_new11[j+10][i]*kernal[10])
